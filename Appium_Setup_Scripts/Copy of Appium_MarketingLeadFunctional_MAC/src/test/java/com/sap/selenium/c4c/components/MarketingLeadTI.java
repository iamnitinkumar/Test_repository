...
public class MarketingLeadTI extends BaseTI {
	...
	public boolean changeTabToOverview() throws Exception {
		return this.NaviagteToFacet(MarketingLeadTI.FACET_OVERVIEW, "NavigateToOverview");
	...
	public boolean changeTabToAttachments() throws Exception {
		return this.NaviagteToFacet(MarketingLeadTI.FACET_ATTACHMENTS, "NavigateToAttachments");
	...
	private AppointmentQC navigateAndGetAppointmentQC() throws Exception {
		...
		System.out.println("navigateAndGetAppointmentQC before  button click");
		this.clickButton(MarketingLeadTI.NEW_APPOINTMENT, "CreateContact_"
				+ tiName);
		Thread.sleep(15000);
		System.out.println("navigateAndGetAppointmentQC after  button click");
	...
	public void ModifyMarketingLeadSummary(Map<String, String> data)
		...
		String value;
		WebElement elem;
		System.out.println("In Modify Marketing Lead");
		for (String key : data.keySet()) {
			...
			case MarketingLeadTI.HOUSE_NO:
				elementToSendKey(By2.partialId(MarketingLeadTI.HOUSE_NO), 10, value);
			...
			case MarketingLeadTI.STREET:
				...
				if ((elem = this.getElementIfExisting(
						By2.partialId(MarketingLeadTI.STREET), 10)) != null) {
					//this.fillDropDown(elem, value);
					this.fillDropDownMobile(By2.partialId(MarketingLeadTI.STREET), value);
				}
				break;
			...
			case MarketingLeadTI.POSTAL_CODE:
				...
				elementToSendKey(By2.partialId(MarketingLeadTI.POSTAL_CODE), 10, value);
				break;
			...
			case MarketingLeadTI.LANGUAGE:
								...
								if ((elem = this.getElementIfExisting(
										By2.startsWithAndPartialId(MarketingLeadTI.LANGUAGE,"input"), 10)) != null) {
									
									//this.fillDropDown(elem, value);
									this.fillDropDownMobile(By2.startsWithAndPartialId(MarketingLeadTI.LANGUAGE,"input"), value);
								}
								break;
	...
	private void navigateAndGetAttachementFacet() throws Exception {
		this.changeTabToAttachments();
		Thread.sleep(10000);
		this.jsClick(this.elementToFindExplicit(By2.partialId("buttonNpRCE_shlAagwzT_s5ACEYYW"), 60));
	...
	public void addAttachement_LocalFile(String pathOfFile)
		...
		System.out.println("Local file attachment");
		Thread.sleep(15000);
		//this.clickButton1("//*[contains(./@id, 'fileuploadhL3U_sxKp64o90AzezqBg1W') and contains(./@id, 'form')]//*[ contains(./@id, 'button')]","addAttachement_Weblink");
		this.clickButton1("//*[contains(./@id, 'fileuploadhL3U_sxKp64o90AzezqBg1W')","addAttachement_Weblink");
		Thread.sleep(15000);
	...
	public void addAttachement_FromLibrary(String data) throws Exception {
		...
		System.out.println("AddAttachment_FromLibrary start");
		this.jsClick(this.getAction(ConstantAttachment.Attachement_FromLibrary));
		Thread.sleep(10000);
		System.out.println("Click one done addAttachement_FromLibrary");
		new AttachmentFacet(driver, this.testName).AddAttachment_FromLibrary(data);
		System.out.println("AddAttachment_FromLibrary done");
		Thread.sleep(10000);
	}
	
	
	protected void clickButton1(String xPath,String measurementName) throws InterruptedException {
		System.out.println("Attachment clickbutton1");
		//WebElement elem = this.elementToFindExplicit(By2.Xpath(xPath),10);
		WebElement elem = driver.findElement(By.cssSelector("div[id^='fileuploadhL3U_sxKp64o90AzezqBg1W']"));
		Thread.sleep(10000);
		System.out.println("Attachment clickbutton1 done");

...
public class AccountTI extends BaseTI {
	...
	{
		this.NaviagteToFacet("navigationitemKXpvpFIOcKgJJ1quMzLTlG_", "Contacts");
	...
	public void editAccountSummary(Map<String, String> data) throws Exception{
		...
		for (String key : data.keySet())
		{
			...
			case AccountTI.COUNTRY:
				...
				{
					this.fillDropDownMobile(By2.startsWithAndPartialId(AccountTI.COUNTRY, "-inpu"), value);
				}				
				break;			
	...
	public void addContact(Map<String, String> data) throws Exception{
		...
		Thread.sleep(5000);
		System.out.println("Create and Save done");
	}

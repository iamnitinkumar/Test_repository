...
public class SalesLead {
	...
	public void createSalesLead(Map<String, String> data, String action) {
		...
		case "OPEN":
			...
			try {
					if(this.getSalesLeadOWL().clickButton(SalesLeadOWL.NEW_BUTTON,"NEW_SalesLead_CLICK"))
	...
	public Boolean AddTaskActivitytoMarketingLead(Map<String, String> data) {
		...
		try {
			...
			if (this.getSalesLeadTI().changeTabToActivities()) {
				try {
					this.getSalesLeadTI().newTask(data);
					Thread.sleep(3000);
				} catch (Exception e) {
	...
	public Boolean AddPhoneCallActivitytoMarketingLead(Map<String, String> data) {
		...
		try {
			if (this.getSalesLeadTI().changeTabToActivities()) {
				try {
					this.getSalesLeadTI().newPhoneCall(data);
					Thread.sleep(3000);
				} catch (Exception e) {
	...
	/**
	 * Prerequisites: SalesLead TI should be open and in EDIT mode
	 * 
	 ...
	 * @param data
	 */
	public void modifySalesLeadSummary(Map<String, String> data) {
		try {
			this.getSalesLeadTI().ModifySalesLeadSummary(data);
		} catch (Exception e) {
	 ...
	 * @return
	 */
	public Boolean SalesLead_copySalesLead(Map<String, String> data) {

		System.out.println("copyMarketingLead() Called");

		try {
			if (this.getSalesLeadTI().executeActionCopy()) {
				this.getSalesLeadQC().createAndSave(data);
				Thread.sleep(10000);
			}
	 ...
	 * @throws Exception
	 */
	public Boolean AddContacttoSalesLead(Map<String, String> data) 	throws Exception {

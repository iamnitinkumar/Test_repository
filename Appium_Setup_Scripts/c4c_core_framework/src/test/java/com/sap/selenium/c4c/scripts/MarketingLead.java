...
public class MarketingLead {
	...
	public void createMarketingLead(Map<String, String> data, String action) {
		...
		case "OPEN":
			...
			try {
				this.getMarketingLeadOWL().clickButton(
						MarketingLeadOWL.NEW_BUTTON, "NEW_MarketingLead_CLICK");
				this.getMarketingLeadQC().createAndOpen(data);
			} catch (Exception e) {
				Assert.fail("MarketingLead creation failed: "
	...
	public Boolean editMarketingLeadToAddContact(Map<String, String> data) {

		try {
			if (this.getMarketingLeadTI().changeTabToContacts()) {

				try {
					this.getMarketingLeadTI().newContact(data);
				} catch (Exception e) {
					Assert.fail("Contact creation failed: "
							+ e.getLocalizedMessage());
				}

			} else {

				System.out.println("editMarketingLeadToAddContact Failed");
			}
	 ...
	 * 
	 * public void editandModifyMarketingLead(Map<String, String> data){ try{
	 * this.getMarketingLeadTI().clickButton("EDIT");
	 * this.getMarketingLeadTI().ModifyOppurtunitySummary(data);
	 * this.getMarketingLeadTI().clickButton("SAVE"); } catch(Exception e){
	 * 
	 * } }
	 */
	 ...
	 * @return
	 */
	public Boolean copyMarketingLead(Map<String, String> data) {

...
public class OpportunityQC extends BaseQC {
	...
	protected void create(Map<String, String> data) throws Exception{
		...
		for (String key : data.keySet())
		{
			...
			switch(key)
			{
			case OpportunityQC.NAME:   	
				driver.manage().timeouts().implicitlyWait(80, TimeUnit.SECONDS); //Mandatory field change
				System.out.println("OpportunityQC.NAME");
				elem = this.elementToFindExplicit(By2.partialId(OpportunityQC.NAME), 15);
//				elem.clear();
//				elem.sendKeys(value);
				this.elementToClear(By2.partialId(OpportunityQC.NAME),10);
				this.elementToSendKey(By2.partialId(OpportunityQC.NAME), 10, value);
				break;
			...
			case OpportunityQC.ACCOUNT:
				...
				if ((elem = this.getElementIfExisting(By2.startsWithAndPartialId(OpportunityQC.ACCOUNT,"ButtonValueHelp"), 10))!= null)
				{
			...
			case OpportunityQC.PRIMARY_CONTACT:
				System.out.println("PRIMARY_CONTACT");
	
				//this.elementToFindExplicit(By2.label(OpportunityQC.PRIMARY_CONTACT_ELEMENT_NAME), 1).sendKeys(value);
				if ((elem = this.getElementIfExisting(By2.startsWithAndPartialId(OpportunityQC.PRIMARY_CONTACT, "ButtonValueHelp"), 10))!= null)
				{
			...
			case OpportunityQC.SOURCE:
				...
				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.SOURCE), 10))!= null)
				{
			...
			case OpportunityQC.EXPECTED_VALUE:
				...
				driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.EXPECTED_VALUE), 10))!= null)
				{
			...
			case OpportunityQC.START_DATE:
				...
				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.START_DATE), 10))!= null)
				{
//					this.fill_datetimebyID(OpportunityQC.START_DATE, value);
			...
			case OpportunityQC.CLOSE_DATE:
				...
				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.CLOSE_DATE), 10))!= null)
				{
//					this.fill_datetimebyID(OpportunityQC.CLOSE_DATE, value);
			...
			case OpportunityQC.SALES_CYCLE:
				System.out.println("SALES_CYCLE");
				//					this.elementToFindExplicit(By2.label(OpportunityQC.SOURCE_ELEMENT_NAME), 1).sendKeys(value);
				//					break;

				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.SALES_CYCLE), 10))!= null)
				{
					this.fillDropDown(elem, value);
				}
				break;
			...
			case OpportunityQC.SALES_PHASE:
				System.out.println("SALES_PHASE");
				//					this.elementToFindExplicit(By2.label(OpportunityQC.SOURCE_ELEMENT_NAME), 1).sendKeys(value);
				//					break;

				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.SALES_PHASE), 10))!= null)
				{
					this.fillDropDown(elem, value);
				}
				break;
			...
			case OpportunityQC.PROBABILITY:
				...
				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.PROBABILITY), 10))!= null)
				{
//					elem.clear();
//					elem.sendKeys(value);
...
//				this.elementToFindExplicit(By2.label(OpportunityQC.PROBABILITY_ELEMENT_NAME), 1).sendKeys(value);
			...
			case OpportunityQC.FORECAST_CATEGORY:
				...
				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.FORECAST_CATEGORY), 10))!= null)
				{
					this.fillDropDown(elem, value);
				}
				break;
			...
			case OpportunityQC.CATEGORY:
				...
				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityQC.CATEGORY), 10))!= null)
				{
					this.fillDropDown(elem, value);
				}
				break;
			...
			case OpportunityQC.CAMPAIGN:
				...
				if ((elem = this.getElementIfExisting(By2.startsWithAndPartialId(OpportunityQC.CAMPAIGN, "ButtonValueHelp"), 10))!= null)
				{
...
//				this.elementToFindExplicit(By2.label(OpportunityQC.OWNER_ELEMENT_NAME), 1).sendKeys(value);
				if ((elem = this.getElementIfExisting(By2.startsWithAndPartialId(OpportunityQC.OWNER, "ButtonValueHelp"), 10))!= null)
				{

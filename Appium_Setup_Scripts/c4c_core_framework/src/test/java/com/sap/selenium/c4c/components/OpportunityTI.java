...
public class OpportunityTI extends BaseTI {
	...
	private AppointmentQC navigateAndGetAppointmentQC() throws Exception
	{
		...
		System.out.println("in navigateAndGetAppointmentQC");
		Thread.sleep(5000);
	...
	private ProductFacet navigateAndGetProductsFacet() throws Exception
	{
		...
		Thread.sleep(10000);
		driver.findElement(By2.text("Add")).click();
		//this.clickButton(OpportunityTI.ADD_SALESTEAM_BUTTON, "AddSalesTeam_"+tiName);
		Thread.sleep(5000);
		System.out.println("out navigateAndGetProductsFacet");
	...
	private ContactFacet navigateAndGetContactFacet() throws Exception
	{
		...
		//this.clickButton(OpportunityTI.ADD_SALESTEAM_BUTTON, "AddSalesTeam_"+tiName);
		Thread.sleep(5000);
		System.out.println("out navigateAndGetContactFacet");
	...
	{
		System.out.println("in navigateAndGetSalesTeamFacet");
		...
		//this.clickButton(OpportunityTI.ADD_SALESTEAM_BUTTON, "AddSalesTeam_"+tiName);
		Thread.sleep(5000);
		System.out.println("out navigateAndGetSalesTeamFacet");
	...
	{
		System.out.println("in executeActionSetAsInProcess");
		this.jsClick(this.getAction(this.actionButton, OpportunityTI.ACTION_SET_AS_IN_PROCESS));
		System.out.println("out executeActionSetAsInProcess");
	...
	public void ModifyOppurtunitySummary(Map<String, String> data) throws InterruptedException{
		...
		for (String key : data.keySet())
		{
			...
			case OpportunityTI.EXPECTED_VALUE:
				Thread.sleep(2000);
				if ((elem = this.getElementIfExisting(By2.partialId(OpportunityTI.EXPECTED_VALUE), 5))!= null)
				{
